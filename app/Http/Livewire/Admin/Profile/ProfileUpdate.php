...
class ProfileUpdate extends Component
{
    ...
    public function updatedImage()
    {
        ...
        $this->dispatchBrowserEvent('role_changed', ['message' => 'Profile changed successfully!']);
    }
    ...
    public function updateProfile(UpdatesUserProfileInformation $updater)
    {
        ...
        $this->dispatchBrowserEvent('role_changed', ['message' => 'Profile updated successfully!']);
    }
    ...
    //     $this->dispatchBrowserEvent('role_changed', ['message' => 'Password changed successfully!']);
    // }
